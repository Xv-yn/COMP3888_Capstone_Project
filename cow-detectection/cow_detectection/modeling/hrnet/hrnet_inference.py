...
--------------------
Stage 2 of the pipeline: Pose Estimation using pretrained HRNet (AP-10K).
- Loads YOLOv8 crops from 'data/input/'
- Runs HRNet inference (no retraining)
- Saves keypoints.pkl for ST-GCN
"""
